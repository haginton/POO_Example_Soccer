...
public abstract class Jugador { // 2. Abstraccion
    ...
    public Jugador(String nombre, String posicion, String nacionalidad, String equipoActual, int numeroCamiseta) {
        this.nombre = nombre;
    ...
    public abstract void preparcion();
}
